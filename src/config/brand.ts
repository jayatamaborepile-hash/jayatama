...
export const brand = {
  ...
  tagline: 'Pondasi Kuat, Bangunan Aman',
  description:
    'Jayatama Bore Pile menyediakan jasa pondasi bore pile profesional di DKI Jakarta. Solusi pondasi yang kuat, aman, dan efisien untuk rumah tinggal, ruko, dan gedung.',
  url: 'https://jayatamaborepile.com',
  locale: 'id_ID',
